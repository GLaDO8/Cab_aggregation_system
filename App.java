...
public class App {
	...
	private int timeStep = 500;  // in millisecs
	...
	private void updateDisplay() {
		...
		for(Car car: cars) {
			disp.draw(car);
			// if car is not idle, if OnTrip, draw line from current location to drop point else from current location to destination.
			// Uses disp.drawLine(loc1, loc2);
